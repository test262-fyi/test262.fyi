...
./scripts/test262.sh node "$(pwd)/node-v0.10.48-linux-x64/bin/node" 6 --preprocessor="$(pwd)/helpers/babel/preprocessor.js" --transformer="$(pwd)/helpers/babel/transformer.js"